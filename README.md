...
paling ringan. Keterangan menjelaskan kegunaan: **Menerjemahkan teks antarbahasa**
...
Pemilih model berupa dropdown ringkas (maksimal 232 px) di bawah baris Model.
Ukuran panel tetap saat daftar dibuka; kotak mengetik selalu terlihat, tidak
tertutup daftar. Klik di luar atau pilih model untuk menutupnya; draf tetap utuh.
Nama panjang bisa turun baris, daftar memiliki satu area gulir, dan panel
menyesuaikan tinggi viewport termasuk mode lanskap.
...
pemilihan model, panel tidak membesar, input tidak tertutup, dan keutuhan draf pesan. Screenshot tersimpan di folder
